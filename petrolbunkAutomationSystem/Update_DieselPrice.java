...
/*public class Update_DieselPrice {
...
import java.util.Date;
 ...
 public class Update_DieselPrice extends JFrame{
		...
		public Update_DieselPrice()
		{
			...
			in.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					try {
						String sql="UPDATE diesel_price SET price=? where city=? and area=? and day=?";
