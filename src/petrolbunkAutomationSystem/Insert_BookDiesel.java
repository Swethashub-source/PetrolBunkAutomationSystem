...
public class Insert_BookDiesel extends JFrame{
	...
	public Insert_BookDiesel() {
		...
		setVisible(true);
		setSize(500,600);
		setTitle("Insert into Booking Diesel:");
		...
		in.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					i=stmt.executeUpdate("insert into  booking_diesel values('"+uphno.getText()+"','"+uamt.getText()+"')");
				}
