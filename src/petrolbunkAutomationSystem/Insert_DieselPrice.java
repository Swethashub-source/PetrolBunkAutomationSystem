...
public class  Insert_DieselPrice extends JFrame{
		...
		in.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					i=stmt.executeUpdate("insert into diesel_price values('"+bcity.getText()+"','"+barea.getText()+"','"+bdate.getText()+"','"+bprice.getText()+"')");
				}
